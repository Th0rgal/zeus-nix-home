...
in
  ...
  #====================BARS====================#
        ...
        "bar/top" = {
          ...
          font-0 = "FuraCode Nerd Font:size=9.5;3";
          font-1 = "FuraCode Nerd Font:style=Bold:size=9.5;3";
        ...
        "bar/bottom" = {
          ...
          #override-redirect = true; # so that offset-y works
          #offset-y = 4; #because my screen is buggy
          ...
          modules-right = "ddrT memory dulT ddrS cpu";
  ...
  #--------------------MODULES--------------------"
        ...
        "module/i3" = {
          ...
          label-unfocused-foreground = quinary;
          ...
          label-visible = "%icon%";
          label-visible-foreground = senary;
